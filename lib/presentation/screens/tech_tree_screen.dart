...
class TechTreeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
          ...
          if (signal >= 100000) {
            ...
            showDialog(
              ...
              builder: (context) => SimpleDialog(
                ...
                title: Text(
                  l10n.transcendence,
                  style: TextStyle(color: VoidTheme.neonCyan),
                ),
                children: [
                  Padding(
                    padding: const EdgeInsets.all(16.0),
                    child: Text(
                      l10n.transcendenceDesc,
                  ...
                  SimpleDialogOption(
                    onPressed: () => _handlePrestige(
                      context,
                      ref,
                      PrestigeChoice.aggressive,
                    ),
                    child: _buildChoice(
                      l10n.pathAggressive,
                      l10n.pathAggressiveDesc,
                      VoidTheme.errorRed,
                    ),
                  ),
                  SimpleDialogOption(
                    onPressed: () =>
                        _handlePrestige(context, ref, PrestigeChoice.silent),
                    child: _buildChoice(
                      l10n.pathSilent,
                      l10n.pathSilentDesc,
                      VoidTheme.neonCyan,
    ...
    _addTechNode(
      ...
      nodes,
      'quantum_sleep',
      l10n.nodeQuantumSleep,
      genPos + const Offset(-150, 0),
      ['perfect_isolation'],
      techTree.quantumSleepUnlocked,
      true,
      (t) => t.copyWith(quantumSleepUnlocked: true),
      100,
      l10n,
    );
    ...
    _addTechNode(
      ...
      nodes,
      'perfect_isolation',
      l10n.nodePerfectIsolation,
      genPos + const Offset(-300, 0),
      ['infinite_loop'],
      techTree.perfectIsolationUnlocked,
      techTree.quantumSleepUnlocked,
      (t) => t.copyWith(perfectIsolationUnlocked: true),
      500,
      l10n,
    );
    ...
    _addTechNode(
      ...
      nodes,
      'infinite_loop',
      l10n.nodeInfiniteLoop,
      genPos + const Offset(-450, 0),
      ['auto_purge'],
      techTree.infiniteLoopUnlocked,
      techTree.perfectIsolationUnlocked,
      (t) => t.copyWith(infiniteLoopUnlocked: true),
      2000,
      l10n,
    );
    ...
    _addTechNode(
      ...
      [],
      techTree.autoPurgeUnlocked,
      techTree.infiniteLoopUnlocked,
      (t) => t.copyWith(autoPurgeUnlocked: true),
      5000,
      l10n,
    );
    ...
    _addTechNode(
      ...
      nodes,
      'voice_humanity',
      l10n.nodeVoiceHumanity,
      filterPos + const Offset(150, 0),
      ['echo_synergy'],
      techTree.voiceOfHumanityUnlocked,
      true,
      (t) => t.copyWith(voiceOfHumanityUnlocked: true),
      150,
      l10n,
    );
    ...
    _addTechNode(
      ...
      nodes,
      'echo_synergy',
      l10n.nodeEchoSynergy,
      filterPos + const Offset(300, 0),
      ['memory_res'],
      techTree.echoSynergyUnlocked,
      techTree.voiceOfHumanityUnlocked,
      (t) => t.copyWith(echoSynergyUnlocked: true),
      600,
      l10n,
    );
    ...
    _addTechNode(
      ...
      'memory_res',
      l10n.nodeMemoryRes,
      filterPos + const Offset(450, 0),
      ['ethics_core'],
      techTree.memoryRestorationUnlocked,
      techTree.echoSynergyUnlocked,
      (t) => t.copyWith(memoryRestorationUnlocked: true),
      2500,
      l10n,
    );
    ...
    _addTechNode(
      ...
      [],
      techTree.ethicsCoreUnlocked,
      techTree.memoryRestorationUnlocked,
      (t) => t.copyWith(ethicsCoreUnlocked: true),
      10000,
      l10n,
    );
    ...
    _addTechNode(
      ...
      ['equi_dest'],
      true,
      true, // Always unlocked root for branch
      (t) => t,
      0,
      l10n,
      size: 50,
    ...
    _addTechNode(
      ...
      'equi_dest',
      l10n.nodeEquiDest,
      riskPos + const Offset(0, 150),
      ['res_core'],
      techTree.equilibriumDestructionUnlocked,
      true,
      (t) => t.copyWith(equilibriumDestructionUnlocked: true),
      1000,
      l10n,
    );
    ...
    _addTechNode(
      ...
      'res_core',
      l10n.nodeResCore,
      riskPos + const Offset(0, 300),
      ['quant_over'],
      techTree.resonanceCoreUnlocked,
      techTree.equilibriumDestructionUnlocked,
      (t) => t.copyWith(resonanceCoreUnlocked: true),
      5000,
      l10n,
    );
    ...
    _addTechNode(
      ...
      'quant_over',
      l10n.nodeQuantOver,
      riskPos + const Offset(0, 450),
      ['dest_will'],
      techTree.quantumOverclockUnlocked,
      techTree.resonanceCoreUnlocked,
      (t) => t.copyWith(quantumOverclockUnlocked: true),
      20000,
      l10n,
    );
    ...
    _addTechNode(
      ...
      [],
      techTree.destructiveWillUnlocked,
      techTree.quantumOverclockUnlocked,
      (t) => t.copyWith(destructiveWillUnlocked: true),
      50000,
      l10n,
    );
    ...
    return Scaffold(
      ...
      body: NeuralGraph(nodes: nodes, width: 2000, height: 2000),
    );
  }
      ...
      NeuralNodeData(
        ...
        onTap: () {
          if (status == NodeStatus.available) {
            _handleUnlock(context, ref, cost, update, l10n);
            ...
            ref
                .read(particleProvider.notifier)
                .burst(
  ...
  void _handleUnlock(
    ...
    if (pipeline.signal.currentAmount >= cost) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(l10n.cost("Insufficient funding")),
